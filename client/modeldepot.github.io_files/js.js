...
(function(){
    ...
    var ba=this,fa=function(){
        if(null===da){
            var a;
            a:{
                var b=ba.document,c=b.querySelector&&b.querySelector("script[nonce]");
                if(c){
                    var d=c.nonce||c.getAttribute("nonce");
                    if(d&&ea.test(d)){a=d;break a}}a=null}da=a||""}return da},ea=/^[\w+/_-]+[=]{0,2}$/,da=null,ha=function(a,b){function c(){}c.prototype=b.prototype;a.$e=b.prototype;
                    a.prototype=new c;
    ...
    var ma=function(a){
        var b=[],c;
        for(c in a.ja)a.ja.hasOwnProperty(c)&&b.push(c.substr(5));return b
    };
    ...
    v.prototype.toString=function(){
        for(var a=[],b=0;b<this.h.length;b++){var c=this.h[b];null===c||void 0===c?a.push(""):
            a.push(c.toString())
        }
        return a.join(",")
    };
    v.prototype.set=function(a,b){
        if("length"==a){
            ...
            ka(a)?this.h[Number(a)]=b:this.ma.set(a,b)
    };
    ...
    ,ra=function(a,b){
        if(Array.prototype.indexOf){
            var c=a.indexOf(b);return"number"==typeof c?c:-1
        }
        for(var d=0;d<a.length;d++)
            if(a[d]===b)return d;return-1
    };
    var w=function(a,b){
        la.call(this);this.jc=a;this.wd=b
    };
    ha(w,la);
    var ua=function(a,b){
        for(var c,d=0;d<b.length&&!(c=ta(a,b[d]),c instanceof g);d++);return c
    }
    ,ta=function(a,b){
 ...
 jQuery v1.9.1 (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    var wa=/\[object (Boolean|Number|String|Function|Array|Date|RegExp)\]/
        ...
        if(null==a)
            return String(a);
    var b=wa.exec(Object.prototype.toString.call(Object(a)));
    ...
    ,za=function(a){
        ...
        for(var b in a);return void 0===b||ya(a,b)
    }
        ,x=function(a,b){
        var c=b||("array"==xa(a)?[]:{}),d;
        for(d in a)if(ya(a,d)){
            var e=a[d];
            "array"==xa(e)?(
                "array"!=xa(c[d])&&(c[d]=[]),c[d]=x(e,c[d]))
                :za(e)?
                    (za(c[d])||(c[d]={}),c[d]=x(e,c[d]))
                    :c[d]=e}return c};
    var Aa=function(a){
        if(a instanceof v){
        ...
        if(a instanceof va){
            for(var e={},f=a.P(),h=f.length(),k=0;k<h;k++)e[f.get(k)]=Aa(a.get(f.get(k)));
            return e
        }
    ...
    var Fa={
        ...
        ,concat:function(a,b){
            for(var c=[],d=0;d<this.length();d++)
                c.push(this.get(d));for(d=1;d<arguments.length;d++)
        ...
        ,filter:function(a,b){
            ...
            return new v(d)},forEach:function(a,b){
                for(var c=this.length(),d=0; d<this.length()&&d<c;d++)
        ...
        ,indexOf:function(a,b,c){
            var d=this.length(),e=void 0===c?0:Number(c);0>e&&(e=Math.max(d+e,0));
            for(var f=e;f<d;f++)
        ...
        ,lastIndexOf:function(a,b,c){
            var d=this.length(),e=d-1;void 0!==c&&(e=0>c?d+c:Math.min(c,e));
            for(var f=e;0<=f;f--)
        ...
        ,map:function(a,b){
            ...
            return new v(d)},pop:function(){
                return this.pop()},push:function(a,b)
        {
        ...
        ,reverse:function(){
            for(var a=Ea(this),b=a.length-1,c=0;0<=b;b--,c++)
                a.hasOwnProperty(b)?this.set(c,a[b]):this.remove(c);
            return this
        }
        ,shift:function(){
            return this.shift()},slice:function(a,b,c){
            var d=this.length();
            void 0===b&&(b=0);
            ...
            for(var e=[],f=b;f<c;f++)
                e.push(this.get(f));
            return new v(e)},some:function(a,b){
                for(var c=this.length(),d=0;d<this.length()&&d<c;d++)
                    if(this.has(d)&&b.m(a,this.get(d),d,this))
                        return!0;
                return!1
        ...
        ,sort:function(a,b){
            var c=Ea(this);void 0===b?c.sort():c.sort(function(c,d){
        ...
        if(a instanceof v){
            if(a.has(b)){
                ...
                if(d instanceof w){
                    var e=Ea(c);
                    e.unshift(this.B());
                    return d.m.apply(d,e)}throw"TypeError: "+b+" is not a function";
            }
            if(0<=ra(Fa.we,b))
                return e=Ea(c)
                    ,e.unshift(this.B()),Fa[b].apply(a,e)
        }
        if(a instanceof w||a instanceof va){
            if(a.has(b)){
                d=a.get(b);
                if(d instanceof w)
                    return e=Ea(c)
    ...
    z.xd=function(a,b,c){
        ...
        }else if(b instanceof va||b instanceof v||b instanceof w){
            var h=b.P(),k=h.length();
            for(e=0;e<k;e++)
                if(d.set(a,h.get(e)),f=this.wa(c),f instanceof g){
                    if("break"==f.w)
                        break;
                    if("return"==f.w)
                        return f
    ...
    z["switch"]=function(a,b,c){
        ...
        if(c.length==b.length+1&&(d=this.evaluate(c[c.length-1]),d instanceof g&&("return"==d.w||"continue"==d.w)))
            return d
    };
    z.xe=function(a,b,c){
    ...
    z["while"]=function(a,b,c,d){
        ...
        if(this.evaluate(c)&&(e=this.wa(f),e instanceof g)){
            if("break"==e.w)
                return;
            if("return"==e.w)
                return e
    ...
    var C=window,D=document,Ma=navigator,Na=function(a,b){
        var c=C[a];
        C[a]=void 0===c?b:c;
        return C[a]},Oa=function(a,b){
            b&&(a.addEventListener?
                a.onload=b:a.onreadystatechange=function(){
                    a.readyState in{
                        loaded:1,complete:1
                    }&&(a.onreadystatechange=null,b())
                })
        },G=function(a,b,c){var d=D.createElement("script");d.type="text/javascript";d.async=!0;d.src=a;Oa(d,b);c&&(d.onerror=c);fa()&&d.setAttribute("nonce",fa());var e=D.getElementsByTagName("script")[0]||D.body||D.head;e.parentNode.insertBefore(d,e);return d},
 ...
 Copyright (c) 2014 Derek Brans, MIT license https://github.com/krux/postscribe/blob/master/LICENSE. Portions derived from simplehtmlparser, which is licensed under the Apache License, Version 2.0 */
    var kc={},lc=null;kc.o="";var mc=null,nc="//www.googletagmanager.com/a?id="+kc.o+"&cv=1",oc={},pc={},qc=D.currentScript?D.currentScript.src:void 0;var rc=function(){},sc=function(a){return"function"==typeof a},tc=function(a){return"string"==xa(a)},uc=function(a){return"number"==xa(a)&&!isNaN(a)},vc=function(a){return Math.round(Number(a))||0},wc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},xc=function(a){var b=[];if(qa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},yc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},zc=function(a,b){if(!uc(a)||!uc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
        a)},Ac=function(){this.prefix="gtm.";this.values={}};Ac.prototype.set=function(a,b){this.values[this.prefix+a]=b};Ac.prototype.get=function(a){return this.values[this.prefix+a]};Ac.prototype.contains=function(a){return void 0!==this.get(a)};var Bc=function(){var a=lc.sequence||0;lc.sequence=a+1;return a},Cc=function(a,b,c){return a&&a.hasOwnProperty(b)?a[b]:c},Dc=function(a){var b=!1;return function(){if(!b)try{a()}catch(c){}b=!0}};var R=function(){var a=function(a){return{toString:function(){return a}}};return{Hb:a("convert_case_to"),Ib:a("convert_false_to"),Jb:a("convert_null_to"),Kb:a("convert_true_to"),Lb:a("convert_undefined_to"),L:a("function"),Ac:a("instance_name"),Bc:a("live_only"),Cc:a("malware_disabled"),Dc:a("once_per_event"),Nb:a("once_per_load"),Ob:a("setup_tags"),Ec:a("tag_id"),Pb:a("teardown_tags")}}();var Ec=new Ac,Fc={},Ic={set:function(a,b){x(Gc(a,b),Fc)},get:function(a){return Hc(a,2)},reset:function(){Ec=new Ac;Fc={}}},Hc=function(a,b){return 2!=b?Ec.get(a):Jc(a)},Jc=function(a,b,c){var d=a.split(".");var e=function(a,b){for(var c=0;void 0!==a&&c<d.length;c++){if(null===a)return!1;a=a[d[c]]}return void 0!==a||1<c?a:b.length?e(Kc(b.pop()),b):Lc(d)};return e(Fc.eventModel,[b,c]);return Lc(d)},Lc=function(a){for(var b=Fc,c=0;c<a.length;c++){if(null===
    ...
    var Wd={event:function(a){var b=a[1];if(tc(b)&&!(3<a.length)){var c;if(2<a.length){if(!za(a[2]))return;c=a[2]}var d=Td(b,c);var e;var f=c,h=Hc("gtag.fields.send_to",2);tc(h)||(h="send_to");var k=f&&f[h];void 0===k&&(k=Hc(h,2),void 0===k&&(k="default"));if(tc(k)||qa(k)){for(var l,m=k.toString().replace(/\s+/g,"").split(","),n=[],p=0;p<m.length;p++)0<=m[p].indexOf("-")?n.push(m[p]):n=n.concat(Pd[m[p]]||[]);l=n;for(var q={},r=0;r<l.length;++r){var u=Nd(l[r]);u&&(q[u.id]=
            u)}var t=[],A;for(A in q)if(q.hasOwnProperty(A)){var J=q[A];"AW"===J.prefix&&J.ia[1]&&t.push(J.containerId)}for(var E=0;E<t.length;++E)delete q[t[E]];var B=[],O;for(O in q)q.hasOwnProperty(O)&&B.push(q[O]);e=B}else e=void 0;if(!e)return;var F=Sd();F||Vd();for(var L=[],I=0;F&&I<e.length;I++){var M=e[I];L.push(M.id);Ud(M)}d.eventModel=d.eventModel||{};0<e.length?d.eventModel.send_to=L.join():delete d.eventModel.send_to;return d}},set:function(a){var b;2==a.length&&za(a[1])?
    ...
    var yf=function(){var a=tf("gac");if(a)return decodeURIComponent(a);for(var b=[],c=D.cookie.split(";"),d=/^\s*_gac_(UA-\d+-\d+)=\s*(.+?)\s*$/,e=0;e<c.length;e++){var f=c[e].match(d);f&&b.push({zb:f[1],value:f[2]})}var h={};if(b&&b.length)for(var k=0;k<b.length;k++){var l=b[k].value.split(".");"1"==l[0]&&3==l.length&&l[1]&&(h[b[k].zb]||(h[b[k].zb]=[]),h[b[k].zb].push({timestamp:l[1],W:l[2]}))}var m=[],n;for(n in h)if(h.hasOwnProperty(n)){for(var p=[],q=h[n],r=0;r<q.length;r++)p.push(q[r].W);p=uf(p);
        p.length&&m.push(n+":"+p.join(","))}return m.join(";")},zf=function(a,b,c){};var Af;a:{Af="g";break a;Af="G"}var Bf={"":"n",UA:"u",AW:"a",DC:"d",G:"e",GTM:Af},Cf=function(a){var b=kc.o.split("-"),c=b[0].toUpperCase();return(Bf[c]||"i")+"7n"+(a&&"GTM"===c?b[1]:"")};
    var Df=function(a){return!(void 0===a||null===a||0===(a+"").length)},Ef=function(a,b){var c;if(2===b.C)return a("ord",zc(1E11,1E13)),!0;if(3===b.C)return a("ord","1"),a("num",zc(1E11,1E13)),!0;if(4===b.C)return Df(b.sessionId)&&a("ord",b.sessionId),!0;if(5===b.C)c="1";else if(6===b.C)c=b.vc;else return!1;Df(c)&&a("qty",c);Df(b.gb)&&a("cost",b.gb);Df(b.Ab)&&a("ord",b.Ab);return!0},Ff=encodeURIComponent,Gf=function(a,b){function c(a,b,c){f.hasOwnProperty(a)||(b+="",e+=";"+a+"="+(c?b:Ff(b)))}var d=a.ib,
        e=a.protocol;e+=a.Xa?"//"+d+".fls.doubleclick.net/activityi":"//ad.doubleclick.net/activity";e+=";src="+Ff(d)+(";type="+Ff(a.jb))+(";cat="+Ff(a.qa));var f=a.ld||{},h;for(h in f)f.hasOwnProperty(h)&&(e+=";"+Ff(h)+"="+Ff(f[h]+""));if(Ef(c,a)){Df(a.Cb)&&c("u",a.Cb);Df(a.tran)&&c("tran",a.tran);c("gtm",Cf());!1===a.Nc&&c("npa","1");if(a.fb){var k=xf(a.fa);k&&k.length&&c("gcldc",k.join("."));var l=wf(a.fa);l&&l.length&&c("gclaw",l.join("."));var m=yf();m&&c("gac",m);}Df(a.sb)&&c("prd",a.sb,!0);for(var p in a.Fa)a.Fa.hasOwnProperty(p)&&c(p,a.Fa[p]);e+=b||"";Df(a.Ta)&&c("~oref",a.Ta);a.Xa?Pa(e+"?",a.R):K(e+"?",a.R,a.ka)}else N(a.ka)};
    var If=function(a){if(a)try{if(a.conversion_id&&a.conversion_data){var b="/pagead/conversion/"+Hf(a.conversion_id)+"/?",c=Hf(JSON.stringify(a.conversion_data)),d="https://www.googletraveladservices.com/travel/flights/clk"+b+"conversion_data="+c;if(a.conversionLinkerEnabled){var e;a:{var f=sf(a.conversionPrefix);if("_gcl"==f.xa){var h=vf();if(h&&"gf"==h.D){e=[h.W];break a}}e=uf(nf(f.xa+"_gf"))}var k=e;k&&k.length&&(d+="&gclgf="+Hf(k.join(".")))}K(d,a.onSuccess,a.onFailure)}}catch(l){}},Hf=function(a){return null===
    a||void 0===a||0===String(a).length?"":encodeURIComponent(String(a))};var Jf=!!C.MutationObserver,Kf=void 0,Lf=function(a){if(!Kf){var b=function(){var a=D.body;if(a)if(Jf)(new MutationObserver(function(){for(var a=0;a<Kf.length;a++)N(Kf[a])})).observe(a,{childList:!0,subtree:!0});else{var b=!1;Qa(a,"DOMNodeInserted",function(){b||(b=!0,N(function(){b=!1;for(var a=0;a<Kf.length;a++)N(Kf[a])}))})}};Kf=[];D.body?b():N(b)}Kf.push(a)};var Yf="www.googletagmanager.com/gtm.js";Yf="www.googletagmanager.com/gtag/js";
    ...
    Z.a.gtagaw=["google"],function(){var a=!1,b=!1,c=[],d="send_to aw_remarketing aw_remarketing_only custom_params send_page_view language value currency transaction_id user_id conversion_linker conversion_cookie_prefix page_location page_referrer phone_conversion_number phone_conversion_callback phone_conversion_css_class items aw_merchant_id aw_feed_country aw_feed_language discount disable_merchant_reported_purchases allow_ad_personalization_signals".split(" "),e=function(a){var b=V("google_trackConversion"),
        c=a.gtm_onFailure;"function"==typeof b?b(a)||c():c()},f=function(){for(;0<c.length;)e(c.shift())},h=function(){a||(a=!0,bg(Y("https://","http://","www.googleadservices.com/pagead/conversion_async.js"),function(){f();c={push:e}},function(){f();a=!1}))},k=function(a,c,d,e){if(c){var f=a.ia[0],h=a.ia[1],k=V("_googWcmImpl",function(){k.q=k.q||[];k.q.push(arguments)});V("_googWcmAk",f);b||(b=!0,bg(Y("https://","http://","www.gstatic.com/wcm/loader.js")));var l={ak:f,cl:h};void 0===d&&(l.autoreplace=c);
        k(2,d,l,c,e,new Date,e)}},l=function(a){if(a){for(var b=[],c=0;c<a.length;++c){var d=a[c];d&&b.push({item_id:d.id,quantity:d.quantity,value:d.price})}return b}},m=function(a){var b=a.vtp_conversionId,e=mc,f="gtag.config"==e,m=b.ia[0],n=b.ia[1],A=void 0!==n,J=b.containerId,E=A?b.id:void 0,B=function(a){return Jc(a,J,E)},O=!1!==B("conversion_linker"),F=B("conversion_cookie_prefix");f&&O&&ig(F);if(f&&A){var L=B("phone_conversion_number"),I=B("phone_conversion_callback"),M=B("phone_conversion_css_class"),
        W=B("phone_conversion_options");k(b,L,I||M,W)}var S=!1===B("aw_remarketing")||!1===B("send_page_view")||!1===B("allow_ad_personalization_signals");if(!f||!A&&!S){!0===B("aw_remarketing_only")&&(A=!1);var H={google_conversion_id:m,google_remarketing_only:!A,onload_callback:a.vtp_gtmOnSuccess,gtm_onFailure:a.vtp_gtmOnFailure,google_conversion_format:"3",google_conversion_color:"ffffff",google_conversion_domain:"",google_conversion_label:n,google_conversion_language:B("language"),google_conversion_value:B("value"),
        google_conversion_currency:B("currency"),google_conversion_order_id:B("transaction_id"),google_user_id:B("user_id"),google_conversion_page_url:B("page_location"),google_conversion_referrer_url:B("page_referrer"),google_gtm:Cf(void 0)};!1===B("allow_ad_personalization_signals")&&(H.google_allow_ad_personalization_signals=!1);H.google_read_gcl_cookie_opt_out=!O;O&&F&&(za(F)?H.google_gcl_cookie_prefix=F.aw:H.google_gcl_cookie_prefix=F);var X=function(){var a=B("custom_params"),b={event:e};if(qa(a)){for(var c=
        0;c<a.length;++c){var f=a[c],h=B(f);void 0!==h&&(b[f]=h)}return b}var k=B("eventModel");if(!k)return null;x(k,b);for(var l=0;l<d.length;++l)delete b[d[l]];return b}();X&&(H.google_custom_params=X);!A&&B("items")&&(H.google_gtag_event_data={items:B("items"),value:B("value")});if(A&&"purchase"==e&&B("aw_merchant_id")){H.google_conversion_merchant_id=B("aw_merchant_id");H.google_basket_feed_country=B("aw_feed_country");H.google_basket_feed_language=B("aw_feed_language");H.google_basket_discount=B("discount");
        H.google_basket_transaction_type=e;H.google_disable_merchant_reported_conversions=!0===B("disable_merchant_reported_purchases");var ca=l(B("items"));ca&&(H.google_conversion_items=ca)}c.push(H)}h()};Z.__gtagaw=m;Z.__gtagaw.b="gtagaw";Z.__gtagaw.g=!0}();

    Z.a.get=["google"],function(){(function(a){Z.__get=a;Z.__get.b="get";Z.__get.g=!0})(function(a){if(a.vtp_isAutoTag){for(var b=String(a.vtp_trackingId),c=mc||"",d={},e=0;e<Kd.length;e++){var f=ug(Kd[e],b);void 0!==f&&(d[Kd[e]]=f)}var h=ug("custom_params",b);if(qa(h))for(var k=0;k<h.length;k++){var l=h[k],m=ug(l,b);void 0!==m&&(d[l]=m)}else{var n=U("eventModel");x(n,d)}var p=x(d,void 0);Rg(b);Cg(b,c,p);Dg(b)}else{var q=a.vtp_settings,r=q.eventParameters,u=q.userProperties,t=T(a.vtp_eventParameters,
        "name","value");x(t,r);var A=T(a.vtp_userProperties,"name","value");x(A,u);r.user_properties=u;var J=String(q.streamId),E=String(a.vtp_eventName);Rg(J);Cg(J,E,r);Dg(J)}a.vtp_gtmOnSuccess()})}();


    Z.a.gtagfl=[],function(){function a(a){var b=/^DC-(\d+)(\/([\w-]+)\/([\w-]+)\+(\w+))?$/.exec(a);if(b){var c={standard:2,unique:3,per_session:4,transactions:5,items_sold:6,"":1}[(b[5]||"").toLowerCase()];if(c)return{containerId:"DC-"+b[1],zc:b[3]?a:"",Ic:b[1],Hc:b[3]||"",qa:b[4]||"",C:c}}}function b(a,b){function c(b,c,e){void 0!==e&&0!==(e+"").length&&d.push(b+c+":"+a(e+""))}var d=[],e=b("items")||[];if(qa(e))for(var l=0;l<e.length;l++){var m=e[l],n=l+1;c("i",n,m.id);c("p",n,m.price);c("q",n,m.quantity);
        c("c",n,b("country"));c("l",n,b("language"))}return d.join("|")}function c(a,b,c){var d=/^u([1-9]\d?|100)$/,e=a("custom_map")||{},f=Mc(b,c),m={},n={};if(za(e))for(var p in e)if(e.hasOwnProperty(p)&&d.test(p)){var q=e[p];tc(q)&&(m[p]=q)}for(var r=0;r<f.length;r++){var u=f[r];d.test(u)&&(m[u]=u)}for(var t in m)m.hasOwnProperty(t)&&(n[t]=a(m[t]));return n}(function(a){Z.__gtagfl=a;Z.__gtagfl.b="gtagfl";Z.__gtagfl.g=!0})(function(d){var e=d.vtp_gtmOnSuccess,f=d.vtp_gtmOnFailure,h=a(d.vtp_targetId);if(h){var k=
        function(a){return Jc(a,h.containerId,h.zc||void 0)},l=!1!==k("conversion_linker"),m=k("conversion_cookie_prefix");if("gtag.config"===mc)l&&(ig(m),zf(m,void 0,void 0)),N(e);else{var n={},p=k("dc_custom_params");if(za(p))for(var q in p)if(p.hasOwnProperty(q)){var r=p[q];void 0!==r&&null!==r&&(n[q]=r)}var u="";if(5===h.C||6===h.C)u=b(Fe,k);var t=c(k,h.containerId,h.zc),A=3===kg(),J=!0===k("allow_custom_scripts"),E={qa:h.qa,fb:l,fa:m,gb:k("value"),C:h.C,ld:n,ib:h.Ic,jb:h.Hc,ka:f,R:e,Ta:Ya(Q(eg())),sb:u,
        protocol:A?"http:":"https:",vc:k("quantity"),Xa:J,sessionId:k("session_id"),Ab:k("transaction_id"),Fa:t,Nc:!1!==k("allow_ad_personalization_signals")};Gf(E,void 0)}}else N(f)})}();
    Z.a.gtaggf=["google"],function(){var a=/.*\.google\.com\/booking\/flights.*/,b=function(a){if(a){for(var b=[],c=0,f=0;f<a.length;++f){var h=a[f];!h||void 0!==h.category&&""!==h.category&&"FlightSegment"!==h.category||(b[c]={cabin:h.travel_class,fare_product:h.fare_product,booking_code:h.booking_code,flight_number:h.flight_number,origin:h.origin,destination:h.destination,departure_date:h.start_date},c++)}return b}};(function(a){Z.__gtaggf=a;Z.__gtaggf.b="gtaggf";Z.__gtaggf.g=!0})(function(c){var d=
        mc,e=c.vtp_gtmOnSuccess,f=c.vtp_gtmOnFailure,h=c.vtp_conversionId,k=h.ia[0],l=h.containerId,m=function(a){return Jc(a,l,h.id)},n=!1!==m("conversion_linker"),p=m("conversion_cookie_prefix");if("gtag.config"===d)n&&ig(p),N(e);else{var q={conversion_id:k,onFailure:f,onSuccess:e,conversionLinkerEnabled:n,conversionPrefix:p};if("purchase"===d){var r=a.test(eg()),u={partner_id:k,trip_type:m("trip_type"),total_price:m("value"),currency:m("currency"),is_direct_booking:r,flight_segment:b(m("items"))},t=m("passengers");
        t&&"object"===typeof t&&(u.passengers_total=t.total,u.passengers_adult=t.adult,u.passengers_child=t.child,u.passengers_infant_in_seat=t.infant_in_seat,u.passengers_infant_in_lap=t.infant_in_lap,u.passengers_senior=t.senior);q.conversion_data=u}If(q)}})}();
    ...
    Z.a.gtagua=["google"],function(){var a,b={client_id:1,client_storage:"storage",cookie_name:1,cookie_domain:1,cookie_expires:1,cookie_path:1,cookie_update:1,sample_rate:1,site_speed_sample_rate:1,use_amp_client_id:1,store_gac:1,conversion_linker:"storeGac"},c={anonymize_ip:1,app_id:1,app_installer_id:1,app_name:1,app_version:1,campaign:{name:"campaignName",source:"campaignSource",medium:"campaignMedium",term:"campaignTerm",content:"campaignContent",id:"campaignId"},currency:"currencyCode",description:"exDescription",
        ...
        h=function(a,b,c,d){if(void 0!==c)if(f[b]&&(c=wc(c)),"anonymize_ip"!=b||c||(c=void 0),1===a)d[k(b)]=c;else if(tc(a))d[a]=c;else for(var e in a)a.hasOwnProperty(e)&&void 0!==c[e]&&(d[a[e]]=c[e])},k=function(a){return a&&tc(a)?a.replace(/(_[a-z])/g,function(a){return a[1].toUpperCase()}):a},l=function(a,b,c){a.hasOwnProperty(b)||(a[b]=c)},m=function(a,e,f){var k={},m={},n={},p;var q=ug("experiments",a);if(qa(q)){for(var t=[],r=0;r<q.length;r++){var u=q[r];if(void 0!=u){var A=u.id,S=u.variant;void 0!=
        A&&void 0!=S&&t.push(String(A)+"."+String(S))}}p=0<t.length?t.join("!"):void 0}else p=void 0;p&&l(m,"exp",p);var H=ug("custom_map",a);if(za(H))for(var X in H)if(H.hasOwnProperty(X)&&/^(dimension|metric)\d+$/.test(X)){var ca=ug(H[X],a);void 0!==ca&&l(m,X,ca)}for(var sa=Mc(a,void 0),ia=0;ia<sa.length;++ia){var aa=sa[ia],Ba=ug(aa,a);d.hasOwnProperty(aa)?h(d[aa],aa,Ba,k):c.hasOwnProperty(aa)?h(c[aa],aa,Ba,m):b.hasOwnProperty(aa)?h(b[aa],aa,Ba,n):/^(dimension|metric|content_group)\d+$/.test(aa)&&h(1,aa,
            Ba,m)}var ja=String(mc);l(n,"cookieDomain","auto");l(m,"forceSSL",!0);var db="general";0<=Je("add_payment_info add_to_cart add_to_wishlist begin_checkout checkout_progress purchase refund remove_from_cart set_checkout_option".split(" "),ja)?db="ecommerce":0<=Je("generate_lead login search select_content share sign_up view_item view_item_list view_promotion view_search_results".split(" "),ja)?db="engagement":"exception"==ja&&(db="error");l(k,"eventCategory",db);0<=Je(["view_item","view_item_list",
            "view_promotion","view_search_results"],ja)&&l(m,"nonInteraction",!0);"login"==ja||"sign_up"==ja||"share"==ja?l(k,"eventLabel",ug("method",a)):"search"==ja||"view_search_results"==ja?l(k,"eventLabel",ug("search_term",a)):"select_content"==ja&&l(k,"eventLabel",ug("content_type",a));var Ab=k.linker||{};if(Ab.accept_incoming||0!=Ab.accept_incoming&&Ab.domains)n.allowLinker=!0;if(!1===ug("allow_display_features",a)||!1===ug("allow_ad_personalization_signals",a))m.allowAdFeatures=!1;n.name=e;m["&gtm"]=
            ...
            a,void 0)},f=e("items"),h,k=0;f&&k<f.length&&!(h=f[k].list_name);k++);var m=e("custom_map");if(za(m))for(k=0;f&&k<f.length;++k){var n=f[k],p;for(p in m)m.hasOwnProperty(p)&&/^(dimension|metric)\d+$/.test(p)&&l(n,p,n[m[p]])}var q=null,r=mc,u=e("promotions");"purchase"==r||"refund"==r?q={action:r,oa:d(),la:c(f)}:"add_to_cart"==r?q={action:"add",la:c(f)}:"remove_from_cart"==r?q={action:"remove",la:c(f)}:"view_item"==r?q={action:"detail",oa:d(h),la:c(f)}:"view_item_list"==r?q={action:"impressions",Hd:c(f)}:
            "view_promotion"==r?q={action:"promo_view",tb:c(u)}:"select_content"==r&&u&&0<u.length?q={action:"promo_click",tb:c(u)}:"select_content"==r?q={action:"click",oa:{list:e("list_name")||h},la:c(f)}:"begin_checkout"==r||"checkout_progress"==r?q={action:"checkout",la:c(f),oa:{step:"begin_checkout"==r?1:e("checkout_step"),option:e("checkout_option")}}:"set_checkout_option"==r&&(q={action:"checkout_option",oa:{step:e("checkout_step"),option:e("checkout_option")}});q&&(q.Le=e("currency"));return q},p={},
        q=function(a,b){var c=p[a];p[a]=x(b,void 0);if(!c)return!1;for(var d in b)if(b.hasOwnProperty(d)&&b[d]!==c[d])return!0;for(d in c)if(c.hasOwnProperty(d)&&c[d]!==b[d])return!0;return!1},r=function(b){var c=b.vtp_trackingId,d=fd(void 0),f="gtag_"+c.split("-").join("_"),p=function(a){var b=[].slice.call(arguments,0);b[0]=f+"."+b[0];d.apply(window,b)},r=function(){var a=function(a,b){for(var c=0;b&&c<b.length;c++)p(a,b[c])},b=n(c);if(b){var d=b.action;if("impressions"==d)a("ec:addImpression",b.Hd);else if("promo_click"==
            d||"promo_view"==d){var e=b.tb;a("ec:addPromo",b.tb);e&&0<e.length&&"promo_click"==d&&p("ec:setAction",d)}else a("ec:addProduct",b.la),p("ec:setAction",d,b.oa)}},u=function(){var a=ug("optimize_id",c);a&&(p("require",a,{dataLayer:"dataLayer"}),p("require","render"))},F=m(c,f,b.vtp_gtmOnSuccess);q(f,F.Wb)&&d(function(){ed()&&ed().remove(f)});d("create",c,F.Wb);(function(){var a=ug("custom_map",c);d(function(){if(za(a)){var b=F.O,c=ed().getByName(f),d;for(d in a)if(a.hasOwnProperty(d)&&/^(dimension|metric)\d+$/.test(d)){var e=
            c.get(k(a[d]));l(b,d,e)}}})})();(function(a){if(a){var b={};if(za(a))for(var c in e)e.hasOwnProperty(c)&&h(e[c],c,a[c],b);p("require","linkid",b)}})(F.linkAttribution);var L=F.linker;L&&L.domains&&gd(f+".",L.domains,!!L.use_anchor,!!L.decorate_forms);var I=function(a,b,c){c&&(b=""+b);F.O[a]=b},M=mc;"page_view"==M?(u(),p("send","pageview",F.O)):"gtag.config"==M?(u(),0!=F.sendPageView&&p("send","pageview",F.O)):"screen_view"==M?p("send","screenview",F.O):"timing_complete"==M?(I("timingCategory",F.eventCategory,
            ...
            F.eventLabel,!0),void 0!==F.value&&I("eventValue",vc(F.value)),p("send","event",F.O));a||(a=!0,bg("https://www.google-analytics.com/analytics.js",function(){ed().loaded||b.vtp_gtmOnFailure()},b.vtp_gtmOnFailure))};Z.__gtagua=r;Z.__gtagua.b="gtagua";Z.__gtagua.g=!0}();
