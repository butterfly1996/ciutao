...
function getStats(peer) {
    myGetStats(peer, function (results) {
        ...
        for (var i = 0; i < results.length; ++i) {
        	try{
        		if(results[i]["googTargetDelayMs"]>=0 && results[i]["packetsLost"]>=0){
        			latency.innerHTML = results[i]["googTargetDelayMs"]+"ms";
		            lostPacket.innerHTML = results[i]["packetsLost"]
		            console.log(results[i]["packetsLost"]);
		            console.log(results[i]["googTargetDelayMs"]);
		            break;
        		}
        ...
        // console.log(results)
        // try {
        //     latency.innerHTML = results[20]["googTargetDelayMs"]+"ms";
        //     lostPacket.innerHTML = results[20]["packetsLost"]
        //     console.log(results[20]["packetsLost"]);
        //     console.log(results[20]["googTargetDelayMs"]);
        // }catch (e) {
        //     console.log(e);
        // }
